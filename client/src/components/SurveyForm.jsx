...
function SurveyForm() {
    ...
    useEffect(() => {
        ( async () => {
            ...
            xhr.open('GET', 'http://localhost:3000/api/v1/questions/get-all-questions', true);
    ...
    useEffect(() => {
        (async () => {
            ...
            xhr.open('POST', 'http://localhost:3000/api/v1/sessions/new', true);
    ...
    const nextClickHandler = () => {
        ...
        if (currentIndex < questionsArray.length - 1) {
            ...
            xhrFeedback.open('POST', 'http://localhost:3000/api/v1/responses', true);
            ...
            xhrUpdateSessionId.open('PUT', `http://localhost:3000/api/v1/sessions/${sessionId}`, true);
